...
def start():
    ...
    This function:
    - Initializes the shared UDP socket
    - Sends an initial ping with available commands to Godot
...
def _init_udp_socket():
    ...
    if _private_vars["sock"] is None:
        ...
        sender._active_socket[0] = _private_vars["sock"]
